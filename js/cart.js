	...
	for( i = 1 ; i < 11 ; i++){
		...
		if( storage.getItem(i) != null ){
			...
			if( full_fare_num > 0 ){
				...
				$("table#cartContent").append("<tr id='full_"+fn+"'><td class='fn_id'>"+fn+"</td><td class='icon_td'><img src='img/facilityIcon/"+fn+"icon.png'></td><td class='facility_name_hidden'></td><td class='facility_name'>"+info[4]+"</td><td class='full_td'>全票</td><td class='fare_td' id='full_fare_id_"+fn+"'>"+full_fare+"</td><td class='ctrl_td'><div class='ctrl_div'><div class='ctrl-button ctrl-button-decrement' id='full_decrement_"+fn+"'>-</div><div class='ctrl-counter'><input class='ctrl-counter-input' maxlength='3' type='text' onkeyup='this.value=this.value.replace(/[^0-9]/g,'')' value="+full_fare_num+" id='full_fare_num_id_"+fn+"' readonly></div><div class='ctrl-button ctrl-button-increment' id='full_increment_"+fn+"'>+</div></div><span class='hidden_num'>"+full_fare_num+"</span></td><td class='sub_total' id='full_fare_subtotal_id_"+fn+"'>"+full_fare_subtotal+"</td><td class='delete_btn_td'><button class='delete_btn' id='full_fare_delete_btn_id_"+fn+"'>Ｘ</button></td></tr>");
			...
			if( half_fare_num > 0){
				...
				$("table#cartContent").append("<tr id='half_"+fn+"'><td class='fn_id'>"+fn+"</td><td class='icon_td'><img src='img/facilityIcon/"+fn+"icon.png'></td><td class='facility_name_hidden'></td><td class='facility_name'>"+info[4]+"</td><td class='half_td'>半票</td><td class='fare_td' id='half_fare_id_"+fn+"'>"+half_fare+"</td><td class='ctrl_td'><div class='ctrl_div'><div class='ctrl-button ctrl-button-decrement' id='half_decrement_"+fn+"'>-</div><div class='ctrl-counter'><input class='ctrl-counter-input' maxlength='3' type='text' onkeyup='this.value=this.value.replace(/[^0-9]/g,'')' value="+half_fare_num+" id='half_fare_num_id_"+fn+"' readonly></div><div class='ctrl-button ctrl-button-increment' id='half_increment_"+fn+"'>+</div></div><span class='hidden_num'>"+half_fare_num+"</span></td><td class='sub_total' id='half_fare_subtotal_id_"+fn+"'>"+half_fare_subtotal+"</td><td class='delete_btn_td'><button class='delete_btn' id='half_fare_delete_btn_id_"+fn+"'>Ｘ</button></td></tr>");
